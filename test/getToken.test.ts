...
if (argv[2] === 'get') {
  ...
  console.log(
    '原因：github提交的包含私有token会注销按个key，所以加密一下token',
  );
  console.log('例子1: 获取token');
  console.log(
    'node ./getToken.js get 8l78ene5ba234fd108797g3w45h5c27cgh34fujc xx-space',
  );
  console.log('例子2: 获取原始的');
  console.log(
    'npm run getToken origine U2FsdGVkX1+mFddckNom5bvuYt9IMr7p3watpPR9750H4l09QCE5RksQ01Kusl4sQ8agDHPR3f1Ee+0pDqBjwg==',
  );
  console.log('程序退出');
  process.exit();
}
